...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    N2 - Se incrementa en 10 cada x segundos, se muestra la barra durante x porcentaje, luego se esconde y se vuelve a mostrar
     */
    ...
    private class TareaProgressBar extends AsyncTask<Void, Integer, Void> {
        ...
        private final int show = 80;
        private final int hide = 50;
        ...
        */
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            if (progress.getProgress() >= hide && progress.getProgress() < show ) {
                progress.hide();
            } else {
                progress.show();
            }

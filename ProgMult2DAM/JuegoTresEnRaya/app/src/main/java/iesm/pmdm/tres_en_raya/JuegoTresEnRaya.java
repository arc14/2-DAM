...
public class JuegoTresEnRaya {
    ...
    public int getMovimientoMaquina() {
        ...
        // NIVEL DE DIFICULTAD 2: DIFICIL
        return getMovimientoMaquinaDificil();
    }

    private int getMovimientoMaquinaDificil(){
        int casilla = 1;

        int contCasillasJugador = 0;
        ...
        switch (contCasillasJugador){
            case 2: case 3: case 4:
                //Horizontales
                //Fila 1
                if ((tablero[0] == JUGADOR && tablero[1] == JUGADOR && tablero[2] == BLANCO))
                    casilla = 2;
                if ((tablero[0] == JUGADOR && tablero[2] == JUGADOR && tablero[1] == BLANCO))
                    casilla = 1;
                if ((tablero[1] == JUGADOR && tablero[2] == JUGADOR && tablero[0] == BLANCO))
                    casilla = 0;
                //Fila 2
                if ((tablero[3] == JUGADOR && tablero[4] == JUGADOR && tablero[5] == BLANCO ))
                    casilla = 5;
                if ((tablero[3] == JUGADOR && tablero[5] == JUGADOR && tablero[4] == BLANCO ))
                    casilla = 4;
                if ((tablero[4] == JUGADOR && tablero[5] == JUGADOR && tablero[3] == BLANCO ))
                    casilla = 3;
                //Fila 3
                if ((tablero[6] == JUGADOR && tablero[7] == JUGADOR && tablero[8] == BLANCO ))
                    casilla = 8;
                if ((tablero[6] == JUGADOR && tablero[8] == JUGADOR && tablero[7] == BLANCO ))
                    casilla = 7;
                if ((tablero[7] == JUGADOR && tablero[8] == JUGADOR && tablero[6] == BLANCO ))
                    casilla = 6;
                //Verticales
                //Columna 1
                if ((tablero[0] == JUGADOR && tablero[3] == JUGADOR && tablero[6] == BLANCO))
                    casilla = 6;
                if ((tablero[0] == JUGADOR && tablero[6] == JUGADOR && tablero[3] == BLANCO))
                    casilla = 3;
                if ((tablero[3] == JUGADOR && tablero[6] == JUGADOR && tablero[0] == BLANCO))
                    casilla = 0;
                //Columna 2
                if ((tablero[1] == JUGADOR && tablero[4] == JUGADOR && tablero[7] == BLANCO ))
                    casilla = 7;
                if ((tablero[1] == JUGADOR && tablero[7] == JUGADOR && tablero[4] == BLANCO ))
                    casilla = 4;
                if ((tablero[4] == JUGADOR && tablero[7] == JUGADOR && tablero[1] == BLANCO ))
                    casilla = 1;
                //Columna 3
                if ((tablero[2] == JUGADOR && tablero[5] == JUGADOR && tablero[8] == BLANCO ))
                    casilla = 8;
                if ((tablero[2] == JUGADOR && tablero[8] == JUGADOR && tablero[5] == BLANCO ))
                    casilla = 5;
                if ((tablero[5] == JUGADOR && tablero[8] == JUGADOR && tablero[2] == BLANCO ))
                    casilla = 2;

                //Diagonal 1
                if ((tablero[0] == JUGADOR && tablero[4] == JUGADOR && tablero[8] == BLANCO ))
                    casilla = 8;
                if ((tablero[0] == JUGADOR && tablero[8] == JUGADOR && tablero[4] == BLANCO ))
                    casilla = 4;
                if ((tablero[4] == JUGADOR && tablero[8] == JUGADOR && tablero[0] == BLANCO ))
                    casilla = 0;

                //Diagonal 2
                if ((tablero[2] == JUGADOR && tablero[4] == JUGADOR && tablero[6] == BLANCO ))
                    casilla = 6;
                if ((tablero[2] == JUGADOR && tablero[6] == JUGADOR && tablero[4] == BLANCO ))
                    casilla = 4;
                if ((tablero[4] == JUGADOR && tablero[6] == JUGADOR && tablero[2] == BLANCO ))
                    casilla = 2;
